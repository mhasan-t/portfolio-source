            ...
            <FadeIn from="left">
              <div className="max-w-3xl">
                ...
                <div className="mt-10 grid gap-4 sm:grid-cols-2 sm:items-start">
                  <a href="#projectShowcase" className="inline-flex items-center justify-center rounded-full bg-text_primary px-8 py-4 text-base sm:text-lg font-semibold uppercase tracking-[0.12em] text-primary transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_50px_-30px_rgba(223,236,87,0.9)]">
                    View Projects
                  </a>
                ...
                <div className="mt-10 grid gap-4 rounded-[30px] border border-text_primary/15 bg-secondary/90 p-6 text-slate-200 shadow-[0_30px_60px_-40px_rgba(0,0,0,0.65)]">
                  ...
                  <ul className="grid gap-3 text-base sm:text-lg leading-8 sm:grid-cols-2">
            ...
            <FadeIn from="right">
              <div className="rounded-[32px] border border-text_primary/15 bg-secondary/95 p-8 shadow-[0_35px_100px_-60px_rgba(0,0,0,0.7)] backdrop-blur-xl">
                ...
                <div className="mt-6 space-y-4 text-base sm:text-lg leading-8 text-slate-100">
                  ...
                  <p className="inline-flex items-center gap-2 text-text_primary text-base sm:text-lg">
