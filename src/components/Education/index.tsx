              ...
              <div className="relative flex flex-col gap-5">
                <div className="flex flex-col gap-3">
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="inline-flex rounded-full border border-text_primary/20 bg-text_primary/10 px-4 py-2 text-xs uppercase tracking-[0.32em] text-text_primary">
                      {item.duration}
                    </span>
                    {item.location && (
                      <span className="inline-flex rounded-full border border-text_primary/20 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.32em] text-slate-200">
                        {item.location}
                      </span>
                    )}
                  </div>
                ...
                <div className="rounded-[28px] border border-text_primary/10 bg-primary/10 p-6 text-base sm:text-lg leading-8 text-slate-200 shadow-[0_10px_30px_-20px_rgba(0,0,0,0.6)]">
                  <div className="text-sm uppercase tracking-[0.28em] text-text_primary">Key details</div>
                  {Array.isArray(item.details) ? (
                    <ul className="mt-4 grid gap-3 pl-4 text-base sm:text-lg text-slate-200">
